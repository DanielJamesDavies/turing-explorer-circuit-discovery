...
Tests for the ResidSparseExpansion circuit discovery algorithm.
...
class TestRejectionCases:
    ...
    def test_accepted_circuit_has_all_metadata_keys(self, setup):
        ...
        assert circuit.metadata["discovery_method"] == "resid_sparse_expansion"
