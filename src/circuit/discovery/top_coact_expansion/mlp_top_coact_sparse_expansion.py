...
class MlpTopCoactSparseExpansion(TopCoactSparseExpansion):
    """
    MLP-targeted variable-depth top-coactivation sparse expansion with full attn/resid passthrough.
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            target_kinds=("mlp",),
            passthrough_kinds=("attn", "resid"),
            method_name="mlp_top_coact_sparse_expansion",
            config_node=config.discovery.mlp_top_coact_sparse_expansion,
