...
class AttnTopCoactSparseExpansion(TopCoactSparseExpansion):
    """
    Attn-targeted variable-depth top-coactivation sparse expansion with full MLP/resid passthrough.
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            target_kinds=("attn",),
            passthrough_kinds=("mlp", "resid"),
            method_name="attn_top_coact_sparse_expansion",
            config_node=config.discovery.attn_top_coact_sparse_expansion,
