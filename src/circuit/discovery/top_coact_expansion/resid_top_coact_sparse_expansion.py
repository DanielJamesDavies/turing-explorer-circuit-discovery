...
class ResidTopCoactSparseExpansion(TopCoactSparseExpansion):
    """
    Resid-targeted variable-depth top-coactivation sparse expansion with full attn/MLP passthrough.
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            target_kinds=("resid",),
            passthrough_kinds=("attn", "mlp"),
            method_name="resid_top_coact_sparse_expansion",
            config_node=config.discovery.resid_top_coact_sparse_expansion,
