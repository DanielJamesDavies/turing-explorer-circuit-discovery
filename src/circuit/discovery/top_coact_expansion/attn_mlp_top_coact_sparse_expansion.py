...
class AttnMlpTopCoactSparseExpansion(TopCoactSparseExpansion):
    """
    Attn+MLP-targeted variable-depth top-coactivation sparse expansion with resid passthrough.
    """
    ...
    def __init__(
        ...
        super().__init__(
            ...
            passthrough_kinds=("resid",),
            method_name="attn_mlp_top_coact_sparse_expansion",
            config_node=config.discovery.attn_mlp_top_coact_sparse_expansion,
