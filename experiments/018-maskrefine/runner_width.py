...
SUPPORT_NS = {"MS200": 200000, "MS100": 100000}
D_SAE = 40960
TARGET_SEEDS = 3
torch.set_float32_matmul_precision("high")

# deep-resid width sweep: the three seeds where MS50 lost in the main run
D1_PANEL = [(26, 17432), (29, 2753), (35, 6599)]
...
if os.environ.get("SMOKE"):
    TARGET_SEEDS = 1
    lm.steps = 25
    OUT = HERE / "rows_width_smoke.jsonl"
...
for sc_idx, sl in candidate_queue():
    ...
    if a_pos_ev <= 0.05 or nt.shape[0] == 0:
        ...
        continue
    n_seeds_run += 1
    if all((seed_key, a) in done for a in ("MS200", "MS100")):
        continue
